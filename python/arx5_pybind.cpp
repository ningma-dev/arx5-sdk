...
PYBIND11_MODULE(arx5_interface, m)
{
    ...
    py::class_<RobotConfig>(m, "RobotConfig")
        ...
        .def_readwrite("gripper_contact_protection", &RobotConfig::gripper_contact_protection)
        .def_readwrite("gripper_contact_torque_threshold", &RobotConfig::gripper_contact_torque_threshold)
        .def_readwrite("gripper_contact_unload_margin", &RobotConfig::gripper_contact_unload_margin)
        .def_readwrite("gripper_contact_kp_scale", &RobotConfig::gripper_contact_kp_scale)
        .def_readwrite("gripper_contact_torque_filter_alpha", &RobotConfig::gripper_contact_torque_filter_alpha)
